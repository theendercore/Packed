...
interface ImpInventory : Inventory {
    ...
    companion object {
//        fun of(items: DefaultedList<ItemStack>): ImpInventory  { items }


//        fun ofSize(size: Int): ImpInventory = of(DefaultedList.ofSize(size, ItemStack.EMPTY))
